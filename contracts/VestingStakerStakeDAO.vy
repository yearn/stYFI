...
interface IGauge:
    def staking_token() -> address: view
...
def stake(_amount: uint256):
    ...
    extcall vest.call(gauge.address, abi_encode(self, _amount, method_id=method_id("transfer(address,uint256)")))
    extcall gauge.withdraw(_amount)
